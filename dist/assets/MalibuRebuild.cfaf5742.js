import{S as n,i as l,s as r,e as c,h as u,j as d,n as o,l as h,p as m,a3 as p,o as v}from"./vendor.1b3eca0c.js";function k(a){let e;return{c(){e=c("div"),e.innerHTML=`<div class="container svelte-1kkuie1"><h3 class="svelte-1kkuie1">Dear Friends and Neighbors,</h3> 
    <div class="text-container svelte-1kkuie1"><p class="svelte-1kkuie1">If you&#39;re like me and my neighbors that have had your homes damaged or
      ...
      <div class="bottom-text-container svelte-1kkuie1"><p class="svelte-1kkuie1">Feel free to contact me or any one of my staff so we can meet.</p> 
        ...
        <p class="svelte-1kkuie1">Together we will heal and bring these cities back to life to create
          new memories.</p></div></div></div>`,u(e,"class","page-container")},m(t,s){d(t,e,s)},p:o,i:o,o,d(t){t&&h(e)}}}function b(a,e,t){let s;return m(a,p,i=>t(0,s=i)),v(()=>{s()}),[]}class y extends n{constructor(e){super();l(this,e,b,k,r,{})}}export{y as default};
