import{S as n,i,s as r,e as c,a as d,c as h,n as o,g as m,h as p,a6 as u,D as v}from"./vendor.9d10a2da.js";function g(s){let e;return{c(){e=c("div"),e.innerHTML=`<h3 class="svelte-1oa95lk">Dear Friends and Neighbors,</h3> 
  <div class="text-container svelte-1oa95lk"><p class="svelte-1oa95lk">If you&#39;re like me and my neighbors that have had your homes damaged or
    ...
    <div class="bottom-text-container svelte-1oa95lk"><p class="svelte-1oa95lk">Feel free to contact me or any one of my staff so we can meet.</p> 
      ...
      <p class="svelte-1oa95lk">Together we will heal and bring these cities back to life to create new
        memories.</p></div></div>`,d(e,"class","container svelte-1oa95lk")},m(t,a){h(t,e,a)},p:o,i:o,o,d(t){t&&m(e)}}}function b(s,e,t){let a;return p(s,u,l=>t(0,a=l)),v(()=>{a()}),[]}class f extends n{constructor(e){super();i(this,e,b,g,r,{})}}export{f as default};
